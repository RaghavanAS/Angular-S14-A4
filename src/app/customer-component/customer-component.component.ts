...
export class CustomerComponentComponent implements OnInit {
  ...
  // get the customer based on his id and set the flag isNew in case no id is passed
  ngOnInit() {
    ...
    // invoke the get city list method
...
// invoke the getCustomerList method
  ...
  // handling the unsaved changes using the canDeactiavte gaurd
