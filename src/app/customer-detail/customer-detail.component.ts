...
// navigate to customers on edit button click based on his id
  onEdit() {
    this.router.navigate(['/customers', this.id, 'edit']);
  }
  // delete the customer based on his id using customer service deleteCustomer method
  // navigate to customer on successful delete
  onDelete() {
